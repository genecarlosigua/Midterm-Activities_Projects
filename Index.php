    ...
    <div class ="container w-25" align="center" >
        ...
        <?php 
            ...
            if (isset($_POST['btnsend'])) {
                ...
                else if ($usertype === $users[3]['type'] && $username == $users[3]['username'] && $userpass === $users[3]['userpass']) {
                    echo '<div class ="alert alert-success alert-dismissible "><a href="#" class="close" data-dismiss="alert" aria-label="close">&times</a> Welcome to the System: ' . $users[3]['username'] . '</div>'; 
                }  
                else if ($usertype === $users[4]['type'] && $username == $users[4]['username'] && $userpass === $users[4]['userpass']) {
                    echo '<div class ="alert alert-success alert-dismissible "><a href="#" class="close" data-dismiss="alert" aria-label="close">&times</a> Welcome to the System: ' . $users[4]['username'] . '</div>'; 
                }  
                else {
